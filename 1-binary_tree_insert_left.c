...
/**
 * binary_tree_node_N - creates a binary tree node
 * @parent: parnt of the node to create
 * @value: value to store in new node
 *
 * Return: pointer to the new node
 */
binary_tree_t *binary_tree_node_N(binary_tree_t *parent, int value)
{
...
binary_tree_t *binary_tree_insert_left(binary_tree_t *parent, int value)
{
	...
	if (parent == NULL)
		return (NULL);
	left_child = binary_tree_node_N(parent, value);
	if (left_child == NULL)
		return (NULL);
